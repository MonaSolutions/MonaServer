...
public:
	RTMFPDecoding(Invoker& invoker,PoolBuffer& poolBuffer,const RTMFPEngine& engine,RTMFPEngine::Type type) : Decoding("RTMFPDecoding",invoker,poolBuffer),_decoder(engine,type) {}
